...
const menuItems: MenuItem[] = [
  ...
  { id: 'progress', label: 'Прогресс', icon: 'progress', path: '/progress', roles: ['admin', 'client'] },
  ...
  { id: 'profileadmin', label: 'Профиль', icon: 'profile', path: '/profileadmin', roles: ['admin'] },
    { id: 'profile', label: 'Профиль', icon: 'profile', path: '/profile', roles: ['client'] },
  { id: 'profileteacher', label: 'Профиль', icon: 'profile', path: '/profileteacher', roles: ['teacher'] },
];
