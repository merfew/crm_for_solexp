...
import type {
  ...
  LessonEnrollmentDto, CancelEnrollmentDto, UpdateClientDataDto,
  UpdateEmailDto, UpdatePasswordDto, Course, Teacher
} from '../types/index';
...
export const clientApi = {
  ...
  updateEmail: (dto: UpdateEmailDto) =>
    apiClient.patch('/api/Client/profile/email', dto),
  updatePassword: (dto: UpdatePasswordDto) =>
    apiClient.patch('/api/Client/profile/password', dto),
};