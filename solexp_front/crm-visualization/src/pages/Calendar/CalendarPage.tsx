              ...
              <div className={styles.detailRow}>
                <CalendarCheckIcon className={styles.detailIcon} />
                  <div className={styles.detailContent}>
                    ...
                    <span className={`${styles.detailValue} ${getStatusClass(lesson.status)}`}>{getStatusText(lesson.status)}</span>
                </div>
              </div>
              ...
              {lesson.description && (
                <div className={styles.detailRow}>
                  ...
                  <div className={styles.detailContent}>
                    ...
                    <span className={styles.detailValue}>{lesson.description}</span>
                  </div>
                </div>
              )}
              ...
              {lesson.homework && (
                <div className={styles.detailRow}>
                  ...
                  <div className={styles.detailContent}>
                    ...
                    <span className={styles.detailValue}>{lesson.homework}</span>
                  </div>
                </div>
              )}
            </div>

            {/* Список студентов (только для преподавателя) */}
                  ...
                  {lessonDetails && (
                    <div className={styles.studentsStats}>
                      <span className={styles.statsBadge}>
                        Всего: {lessonDetails.totalStudents}
                      </span>
                      <span className={styles.statsBadge}>
                        Присутствуют: {lessonDetails.presentCount}
                      </span>
                      {lessonDetails.absentCount > 0 && (
                        <span className={styles.statsBadge}>
                          Отсутствуют: {lessonDetails.absentCount}
                        </span>
                      )}
                    </div>
                  )}
                    ...
                    <div className={styles.teacherStudentsList}>
                      {lessonDetails.students.map((student) => (
                        <div key={student.idStudent} className={styles.teacherStudentCard}>
                          ...
                          {/* Оценки */}
                          <div className={styles.teacherActionRow}>
                            {editingStudentId === student.idStudent ? (
